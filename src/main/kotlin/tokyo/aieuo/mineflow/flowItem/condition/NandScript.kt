...
open class NandScript: AndScript() {

    override val id = FlowItemIds.CONDITION_NAND

    override val nameTranslationKey = "condition.nand.name"
    override val detailTranslationKey = "condition.nand.detail"

    override fun getDetail(): String {
        val details = mutableListOf("-----------nand-----------")
