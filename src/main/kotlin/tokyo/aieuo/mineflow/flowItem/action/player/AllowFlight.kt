...
class AllowFlight(player: String = "", var allow: Boolean = true) : FlowItem(), PlayerFlowItem {
    ...
    override val nameTranslationKey = "action.allowFlight.name"
    override val detailTranslationKey = "action.allowFlight.detail"
    ...
    override fun execute(source: FlowItemExecutor) = sequence {
        ...
        player.adventureSettings.let {
            it.set(AdventureSettings.Type.ALLOW_FLIGHT, allow)
            it.update()
        }
    ...
    override fun clone(): AllowFlight {
        val item = super.clone() as AllowFlight
