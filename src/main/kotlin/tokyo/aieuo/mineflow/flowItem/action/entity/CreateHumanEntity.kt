...
class CreateHumanEntity(playerName: String = "", pos: String = "", var resultName: String = "human")
    : FlowItem(), PlayerFlowItem, PositionFlowItem {
    ...
    override fun getDetail(): String {
        ...
        return Language.get(detailTranslationKey, listOf(getPlayerVariableName(), getPositionVariableName(), resultName))
    }
